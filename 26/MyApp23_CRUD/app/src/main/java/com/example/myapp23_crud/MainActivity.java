...
public class MainActivity extends AppCompatActivity {
    ...
    Button button_insert,button_view,button_update;
    DB_Helper db_helper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db_helper.Update_Record(editText_id.getText().toString(),editText_un.getText().toString(),
                                        editText_email.getText().toString(),editText_bc.getText().toString());
